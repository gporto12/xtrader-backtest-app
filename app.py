...
def handle_backtest_request():
    ...
    try:
        ...
        dados_historicos = buscar_dados_api(ativo, 'D1', data_inicio, data_fim, POLYGON_API_KEY)
        ...
        resultados_df = rodar_backtest(dados_historicos, ativo, lotes, valor_ponto)
...
if __name__ == '__main__':
    # Esta parte é para rodar localmente. O Render usará o comando Gunicorn.
